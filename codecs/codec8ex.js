...
class Codec8e extends Codec {
  ...
  ioElements() {
    return {
      ...
      390: {
        label: 'OEM Total Fuel Level',
      },
      410: {
        label: 'OEM Battery Charge State',
      },
      411: {
        label: 'OEM Battery charge level',
      },
      412: {
        label: 'OEM Battery power consumption',
      },
      755: {
        label: 'OEM Remaining distanc',
      },
      1151: {
        label: 'OEM Battery State Of Health',
      },
      1152: {
        label: 'OEM Battery State Of Health',
      },
